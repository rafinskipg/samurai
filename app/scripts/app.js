...
GameState.prototype.preload = function() {
    ...
    this.game.load.spritesheet('player', '/assets/player.png',50,50,6);
};
...
GameState.prototype.create = function() {
    ...
    this.player = this.game.add.sprite(this.game.width/2, 0, 'player');

    //Add animation
    this.player.animations.add('standby',[0,1]);
    this.player.animations.add('cut',[2,3,4,5,1]);

    this.player.animations.play('standby', 5, true);
...
GameState.prototype.cut = function() {
    this.cutAnimation = this.player.animations.play('cut', 10);
}
...
GameState.prototype.update = function() {
    ...
    if(this.cutAnimation && this.cutAnimation.isFinished){
        this.player.animations.play('standby',5,true);
    }
};
